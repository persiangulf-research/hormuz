...
(function(){
  const examples=[
    ...
    {num:'04',title:'Three Accommodate confirmations — 19–30 March 2026',params:'Sr=0.78, Trump talks, 2,500 Marines',res:'NE confirmed x3',
     steps:[
      {label:'Bessent waiver (19 Mar) — Sr=0.78',eq:'G+(S−0.78) = 17.22 > 0 · a* unchanged',note:'Unsanctioning 140M barrels without Iranian concessions. Textbook Accommodate: U.S. pays −H=−7 to avoid E*=13.7 penalty. 4.3% of Sr threshold. Trap geometry unchanged.'},
      {label:'Trump talks signal (23 Mar) — Sr≈2.7 probability-weighted',eq:'Brent −11% to $99.94. Iran denied talks. Sr(structural)=0.',note:'Trump Truth Social: "very productive conversations toward complete and total resolution." Brent crash largest single-day oil move on record. Iran denial → P(genuine talks)≈0.30. Expected Sr≈2.7 (still 15% of threshold=18). U.S. Accommodate confirmed again.'},
      {label:'Marine deployment (20–23 Mar) — Sr(troops)=0',eq:'2,500 Marines + USS Boxer. ΔE*≈−0.45 via m. Sr=0.',note:'Physical transit restoration attempt. Separability principle (Eq.9): ships escort on physical plane Φ but yuan settlement continues on financial plane Ψ. Sr(escort)=0. Dominant strategy unchanged. Third consecutive Accommodate action in 11 days.'},
    ]},
    {num:'05',title:'Hypothetical: Naval escalation (counterfactual)',params:'G=8, S=10, H=7, E*=14',res:'Payoff: −21',
     steps:[
      {label:'U.S. chooses Escalate despite E*=14',eq:'U_A(Escalate) = −7−13.7 = −20.7',note:'Escalating against a credible Hormuz threat at c=0.9 costs −20.7 vs Accommodate at −7. A 13.7-unit penalty.'},
