...
(function(){
  const examples=[
    ...
    {num:'04',title:'India bilateral deal — k raises above 1 (March 2026)',params:'k: Iran(1) + India(partial) ≈ 1.3',res:'Cascade advancing',
     steps:[
      {label:'India\'s deal structure (confirmed 15 March)',eq:'3 Iranian tankers freed; 2 LPG carriers transited 15 March with yuan settlement. k += 0.3',note:'India is the world\'s third-largest oil importer. Its bilateral deal adds k=+0.3 — current total k≈1.3. India accounts for ~8% of global oil demand. P_s(0) eroded ~18% for remaining Gulf states.'},
      ...
      {label:'23 March Trump-Iran talks signal',eq:'If genuine deal: Sr≈18, c→0.10, yuan incentive collapses. k stops growing.',note:'Trump-Iran talks signal (23 Mar) is the first event that could reverse cascade momentum. If Sr=18 deal materialises, Iran\'s yuan dominant strategy breaks, k growth halts. Iran denied talks — cascade continues. This is the key watchpoint for Eq.7: monitor whether talks produce structural Sr.'},
    ]},
